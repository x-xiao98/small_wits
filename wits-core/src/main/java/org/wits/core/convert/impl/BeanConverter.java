...
import org.wits.core.bean.BeanUtil;
import org.wits.core.bean.copier.BeanCopier;
import org.wits.core.bean.copier.CopyOptions;
import org.wits.core.bean.copier.ValueProvider;
import org.wits.core.convert.AbstractConverter;
import org.wits.core.convert.ConvertException;
import org.wits.core.map.MapProxy;
import org.wits.core.util.ObjectUtil;
import org.wits.core.util.ReflectUtil;
import org.wits.core.util.StrUtil;
import org.wits.core.util.TypeUtil;
...
public class BeanConverter<T> extends AbstractConverter<T> {
	...
	protected T convertInternal(Object value) {
		...
		for (Class<?> anInterface : interfaces) {
			if("org.wits.json.JSONBeanParser".equals(anInterface.getName())){
				// issue#I7M2GZ
