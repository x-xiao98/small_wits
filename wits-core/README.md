<p align="center">
	<a href="https://wits.cn/"><img src="https://cdn.jsdelivr.net/gh/looly/wits-site/images/logo.jpg" width="45%"></a>
</p>
<p align="center">
	<strong>🍬A set of tools that keep Java sweet.</strong>
</p>
<p align="center">
	👉 <a href="https://wits.cn">https://wits.cn/</a> 👈
</p>

## 📚wits-core 模块介绍

`wits-core`提供了最常使用的基础工具类，包括集合、Map、IO、线程、Bean、图片处理、线程并发等便捷工具。
